...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { date: @day.date, desc: @day.desc, theme: @day.theme, user_id: @day.user_id } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { date: @day.date, desc: @day.desc, theme: @day.theme, user_id: @day.user_id } }
